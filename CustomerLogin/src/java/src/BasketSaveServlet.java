 ...
 * @author HP
 */
public class BasketSaveServlet extends HttpServlet {
...
"    </header><br><br><br>");
        out.println("<center>");
        st.executeUpdate("INSERT INTO ITEMS VALUES ('"+phone+"','"+items+"')");
        out.println("<br><br><h1>Your basket has been saved successfully</h1>");
        out.println("<br><br><a href='payment.html' class=\"btn btn-style btn-primary\">Visit Payment Options</a>");
        out.println("</center>");
...
"    <script src=\"assets/js/theme-change.js\"></script></body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BasketSaveServlet.class.getName()).log(Level.SEVERE, null, ex);
