...
public class FailedLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FailedLogin</title>");   
...
"    </header><br><br><br>");
            out.println("<center>");
            out.println("<br><br><h1>Something went wrong, Please try again!</h1>");
            out.println("<br><br><a href=\"login.html\" class=\"btn btn-style btn-primary\"> Login</a>");
            //out.println("<h1>Servlet FailedLogin at " + request.getContextPath() + "</h1>");
            out.println("</center>");
