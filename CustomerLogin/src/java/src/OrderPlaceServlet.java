...
"        </div>\n" +
"    </header>"
                    + "<div style=\"margin: 8px auto; display: block; text-align:center;\"></div><br><br><br>");
            out.println("<center>");
            out.println("<br><br><h2>Your order is about to place.</h2>");
            out.println("<br><br><h1>Please select Delivery/Collection,</h1>");
            out.println("<br><br><a href='checkout.html' class=\"btn btn-style btn-primary\">Click here</a>");
...
"    </footer><script src=\"assets/js/theme-change.js\"></script></body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrderPlaceServlet.class.getName()).log(Level.SEVERE, null, ex);
